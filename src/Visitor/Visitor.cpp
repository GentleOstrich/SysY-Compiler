...
int Visitor::handleFuncFParam(Node *funcFParam, string *code)
{
...
{
    int ret = 0;
    if (!unaryExp->getWord().empty())
    { // is Ident '(' [FuncRParams] ')'
...
void Visitor::handleFuncRParams(Node *funcRParams, Symbol *funcSymbol, string *code)
{
